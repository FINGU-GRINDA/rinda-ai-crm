...
import { Customer, ImageSize, ProcessingStatus } from '../types';
import { generateProposalStrategy, generateProposalCoverImage } from '../services/geminiService';
import { useBackgroundTasks } from '../contexts/BackgroundTaskContext';
import { IconWand, IconBrain, IconLoader, IconCheck, IconX, IconArrowRight, IconClock } from './Icons';
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-5 rounded-lg border border-blue-200 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">커버 이미지 화질 선택</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">생성 방식 선택</label>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                            generationMode === 'foreground' ? 'bg-blue-500 text-white' : 'bg-slate-100 text-slate-500'
                          }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in duration-300">
              ...
              <div className="space-y-4">
                <div className="rounded-xl overflow-hidden shadow-lg border-2 border-slate-200 bg-slate-100 min-h-[200px] flex items-center justify-center group hover:border-blue-300 transition-colors">
                  {generatedImage ? (
                    <img src={generatedImage} alt="Generated Cover" className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-300" />
                  ) : (
