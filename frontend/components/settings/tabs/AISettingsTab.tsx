...
export const AISettingsTab: React.FC<AISettingsTabProps> = ({
  ...
  }, [isDirty, isSaving, onFormStateChange, handleSave, handleReset])
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">
          AI 기능 사용을 위한 Google Gemini API Key를 설정하세요.
        </p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-indigo-700">
                서버에 Gemini API Key가 설정되어 있습니다. 서버 측 AI 기능(데이터 보강, 미팅 요약
                등)을 사용할 수 있습니다.
              </p>
              <p className="text-xs text-indigo-600 mt-1">모델: {serverStatus.model}</p>
            </div>
          </div>
        </div>
      ) : (
