...
import { pageTitle, pageDesc, card, sectionTitle, infoNote, statusDot } from '../tokens';
    ...
    <div className="space-y-6">
      ...
      {!isLoading && !connected && (
        <div className={infoNote}>
          ...
          <p>
            서버의 <code className="px-1.5 py-0.5 bg-white border border-slate-200 rounded text-xs text-slate-700">GEMINI_API_KEY</code>{' '}
            환경변수를 설정하면 AI 기능이 자동으로 활성화됩니다. 자세한 절차는 운영 가이드를 참고하세요.
          </p>
        </div>
      )}
    </div>
