...
const NOTIFICATION_ROWS: { key: keyof SlackSettings['notifications']; label: string; desc: string }[] = [
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={validation === 'validating' || !webhookDraft || webhookDraft === settings.webhookUrl && settings.isValidated}
      ...
      <div className={infoNote}>
        ...
        <p>Slack 워크스페이스에서 Apps → Incoming Webhooks 추가 → 알림을 받을 채널 선택 후 생성된 URL을 복사해 붙여넣으세요.</p>
        <a
