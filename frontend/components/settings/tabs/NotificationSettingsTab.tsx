...
const BROWSER_TYPES: {
  key: keyof NotificationSettings["browser"]["types"]
  label: string
  desc: string
}[] = [
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className={pageDesc}>
          어디로 알림을 받을지 선택합니다. Slack 알림은 Slack 탭에서 설정합니다.
        </p>
      </header>
      ...
      <div className={infoNote}>
        Slack 메시지로 알림을 받으려면 <span className="font-medium text-slate-800">Slack</span>{" "}
        탭에서 Webhook을 연동하세요.
      </div>
    </div>
  )
