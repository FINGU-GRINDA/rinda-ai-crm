...
import { IconCheck, IconClock, IconPlay, IconSparkles, IconX } from "./Icons"
...
export const ICPSettings: React.FC<Props> = ({
  isOpen,
  onClose,
  onManualRun,
    ...
    <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="space-y-6 mb-6">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">산업 분야 *</label>
