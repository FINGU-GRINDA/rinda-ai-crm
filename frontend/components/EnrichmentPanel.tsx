...
import { IconArrowRight, IconBrain, IconBuilding, IconGlobe, IconNews, IconSearch } from "./Icons"
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            {data.recentNews.map((news, idx) => (
              <li
                key={idx}
                className="flex items-start text-sm text-slate-700 bg-slate-50 p-3 rounded-lg border border-slate-100 hover:bg-slate-100 transition-colors"
              >
