...
import { Customer, FollowUpType, FollowUpPriority, ScheduledFollowUp } from '../../types';
import { IconPlus, IconX, IconClock, IconMail, IconMessageSquare, IconCalendar } from '../Icons';
