...
import { ScheduledFollowUp, Customer, FollowUpType } from '../../types';
import { IconChevronDown, IconChevronUp, IconMail, IconMessageSquare, IconCalendar } from '../Icons';
