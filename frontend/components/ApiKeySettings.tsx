          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                ...
                {validationStatus === "valid" && <IconCheck className="w-5 h-5 text-emerald-600" />}
                {validationStatus === "invalid" && <IconX className="w-5 h-5 text-red-600" />}
